  ...
  flowy.load = function () {
      ...
      if (event.which != 3 && (active || rearrange)) {
        ...
        if (parseInt(drag.querySelector(".blockid").value) === 0 && rearrange) {
          ...
          blockstemp.filter(function (a) {
            return a.id == 0;
          })[0].x = drag.getBoundingClientRect().left + window.scrollX + parseInt(window.getComputedStyle(drag).width) / 2;
          blockstemp.filter(function (a) {
            return a.id == 0;
          })[0].y = drag.getBoundingClientRect().top + window.scrollY + parseInt(window.getComputedStyle(drag).height) / 2;
    ...
    function snap(drag, i, blocko) {
      ...
      drag.style.left = blocks.filter(function (id) {
        return id.id == blocko[i];
      })[0].x - totalwidth / 2 + totalremove - (canvas_div.getBoundingClientRect().left + window.scrollX) + canvas_div.scrollLeft + "px";
      drag.style.top = blocks.filter(function (id) {
        return id.id == blocko[i];
      })[0].y + blocks.filter(function (id) {
        return id.id == blocko[i];
      })[0].height / 2 + paddingy - (canvas_div.getBoundingClientRect().top + window.scrollY) + "px";

      if (rearrange) {
        blockstemp.filter(function (a) {
          return a.id == parseInt(drag.querySelector(".blockid").value);
        })[0].x = drag.getBoundingClientRect().left + window.scrollX + parseInt(window.getComputedStyle(drag).width) / 2 + canvas_div.scrollLeft;
        blockstemp.filter(function (a) {
          return a.id == parseInt(drag.querySelector(".blockid").value);
        })[0].y = drag.getBoundingClientRect().top + window.scrollY + parseInt(window.getComputedStyle(drag).height) / 2 + canvas_div.scrollTop;
        blockstemp.filter(function (a) {
      ...
      var arrowy = parseFloat(arrowhelp.y - arrowhelp.height / 2 - (blocks.filter(function (id) {
        ...
        return id.parent == blocko[i];
      })[0].height / 2) + canvas_div.scrollTop);
      ...
      if (arrowx < 0) {
        ...
        document.querySelector('.arrowid[value="' + parseInt(drag.querySelector(".blockid").value) + '"]').parentNode.style.left = blocks.filter(function (a) {
          return a.id == blocko[i];
        })[0].x - 20 - (canvas_div.getBoundingClientRect().left + window.scrollX) + canvas_div.scrollLeft + "px";
      }
    ...
    flowy.moveBlock = function (event) {
      ...
      if (active) {
        ...
        blockstemp.filter(function (a) {
          return a.id == parseInt(drag.querySelector(".blockid").value);
        }).y = drag.getBoundingClientRect().left + window.scrollX + parseInt(window.getComputedStyle(drag).height) / 2 + canvas_div.scrollTop;
      }
    ...
    function checkOffset() {
      ...
      if (offsetleft < canvas_div.getBoundingClientRect().left + window.scrollX) {
        ...
        for (var w = 0; w < blocks.length; w++) {
          ...
          })[0].id + "']").parentNode.style.left = blocks.filter(function (a) {
            return a.id == blocko[w];
          })[0].x - blocks.filter(function (a) {
            return a.id == blocko[w];
          })[0].width / 2 - offsetleft + 20 + "px";
      ...
      if (offsetleftold < canvas_div.getBoundingClientRect().left + window.scrollX) {
        ...
        for (var w = 0; w < blocks.length; w++) {
          document.querySelector(".blockid[value='" + blocks.filter(function (a) {
            ...
            return a.id == blocko[w];
          })[0].width / 2 - offsetleftold - 20 + "px";
          blocks.filter(function (a) {
            return a.id == blocko[w];
          })[0].x = document.querySelector(".blockid[value='" + blocks.filter(function (a) {
            return a.id == blocko[w];
          })[0].id + "']").parentNode.getBoundingClientRect().left + window.scrollX + blocks.filter(function (a) {
            return a.id == blocko[w];
          })[0].width / 2;
          ...
          if (blocks.filter(function (a) {
            ...
            if (arrowx < 0) {
              ...
              })[0].x - 20 - (canvas_div.getBoundingClientRect().left + window.scrollX) + "px";
            }
          }
        }
      ...
      for (var z = 0; z < result.length; z++) {
        ...
        for (var w = 0; w < blocks.filter(function (id) {
          ...
          document.querySelector('.arrowid[value="' + children.id + '"]').parentNode.style.top = blocks.filter(function (id) {
            ...
            return id.id == children.parent;
          })[0].height / 2 - (canvas_div.getBoundingClientRect().top + window.scrollY) + "px";
