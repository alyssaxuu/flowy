...
var flowy = function flowy(canvas, grab, release, snapping, rearrange, spacing_x, spacing_y) {
  if (!grab) {
    grab = function grab() {};
  }
  ...
  flowy.load = function () {
    ...
    flowy.beginDrag = function (event) {
      ...
      if (event.which != 3 && event.target.closest(".create-flowy")) {
        ...
        if (blocks.length === 0) {
          ...
          newNode.innerHTML += "<input type='hidden' name='blockid' class='blockid' value='" + (Math.max.apply(Math, blocks.map(function (a) {
      ...
      if (event.which != 3 && (active || rearrange)) {
        ...
        if (parseInt(drag.querySelector(".blockid").value) === 0 && rearrange) {
          ...
          blockstemp.filter(function (a) {
            ...
            return a.id == 0;
          }.bind(this))[0].x = drag.getBoundingClientRect().left + window.scrollX + parseInt(window.getComputedStyle(drag).width) / 2;
          blockstemp.filter(function (a) {
            _newArrowCheck(this, _this2);

            return a.id == 0;
          }.bind(this))[0].y = drag.getBoundingClientRect().top + window.scrollY + parseInt(window.getComputedStyle(drag).height) / 2;
    ...
    function snap(drag, i, blocko) {
      ...
      drag.style.left = blocks.filter(function (id) {
        ...
        return id.id == blocko[i];
      }.bind(this))[0].x - totalwidth / 2 + totalremove - (canvas_div.getBoundingClientRect().left + window.scrollX) + canvas_div.scrollLeft + "px";
      drag.style.top = blocks.filter(function (id) {
        ...
        return id.id == blocko[i];
      }.bind(this))[0].height / 2 + paddingy - (canvas_div.getBoundingClientRect().top + window.scrollY) + "px";
      ...
      if (rearrange) {
        ...
        }.bind(this))[0].x = drag.getBoundingClientRect().left + window.scrollX + parseInt(window.getComputedStyle(drag).width) / 2 + canvas_div.scrollLeft;
        blockstemp.filter(function (a) {
          _newArrowCheck(this, _this3);

          return a.id == parseInt(drag.querySelector(".blockid").value);
        }.bind(this))[0].y = drag.getBoundingClientRect().top + window.scrollY + parseInt(window.getComputedStyle(drag).height) / 2 + canvas_div.scrollTop;
        blockstemp.filter(function (a) {
          _newArrowCheck(this, _this3);
      ...
      if (arrowx < 0) {
        canvas_div.innerHTML += '<div class="arrowblock"><input type="hidden" class="arrowid" value="' + drag.querySelector(".blockid").value + '"><svg preserveaspectratio="none" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M' + (blocks.filter(function (a) {
          _newArrowCheck(this, _this3);
        ...
        document.querySelector('.arrowid[value="' + parseInt(drag.querySelector(".blockid").value) + '"]').parentNode.style.left = blocks.filter(function (a) {
          ...
          return a.id == blocko[i];
        }.bind(this))[0].x - 20 - (canvas_div.getBoundingClientRect().left + window.scrollX) + canvas_div.scrollLeft + "px";
      }
    ...
    flowy.moveBlock = function (event) {
      ...
      if (active) {
        ...
        blockstemp.filter(function (a) {
          ...
          return a.id == parseInt(drag.querySelector(".blockid").value);
        }.bind(this)).x = drag.getBoundingClientRect().left + window.scrollX + parseInt(window.getComputedStyle(drag).width) / 2 + canvas_div.scrollLeft;
        blockstemp.filter(function (a) {
          _newArrowCheck(this, _this4);

          return a.id == parseInt(drag.querySelector(".blockid").value);
        }.bind(this)).y = drag.getBoundingClientRect().left + window.scrollX + parseInt(window.getComputedStyle(drag).height) / 2 + canvas_div.scrollTop;
      }
      ...
      if (offsetleftold < canvas_div.getBoundingClientRect().left + window.scrollX) {
        ...
        for (var w = 0; w < blocks.length; w++) {
          ...
          blocks.filter(function (a) {
            ...
            return a.id == blocko[w];
          }.bind(this))[0].id + "']").parentNode.getBoundingClientRect().left + window.scrollX + blocks.filter(function (a) {
            _newArrowCheck(this, _this8);
          ...
          if (blocks.filter(function (a) {
            ...
            if (arrowx < 0) {
              ...
              }.bind(this))[0].x - 20 - (canvas_div.getBoundingClientRect().left + window.scrollX) + "px";
            }
          }
        }
      ...
      for (var z = 0; z < result.length; z++) {
        ...
        for (var w = 0; w < blocks.filter(function (id) {
          ...
          document.querySelector('.arrowid[value="' + children.id + '"]').parentNode.style.top = blocks.filter(function (id) {
            ...
            return id.id == children.parent;
          }.bind(this))[0].height / 2 - (canvas_div.getBoundingClientRect().top + window.scrollY) + "px";
